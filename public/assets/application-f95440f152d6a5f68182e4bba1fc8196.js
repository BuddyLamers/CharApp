...
//   CharApp.initialize();
// });
(function() { this.JST || (this.JST = {}); this.JST["bars/sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <ul class="sidebar-box">\n   <!-- again use counter caches -->\n\n  <li>\n    <a href=\'\'>\n      All Characters <i class=\'count\'>',  user.get('characters_count') ,'</i>\n    </a>\n  </li>\n\n  <li>\n    <a href=\'#forked\'>\n      Forked <i class=\'count\'>',  user.get('forked_characters_count') ,'</i>\n    </a>\n  </li>\n\n  <li>\n    <a href=\'#starred\'>\n      Starred <i class=\'count\'>',  user.get('starred_characters_count') ,'</i>\n    </a>\n  </li>\n\n  <li>\n    <a href=\'#public\'>\n      Public <i class=\'count\'>',  user.get('public_characters_count') ,'</i>\n    </a>\n  </li>\n\n  <li>\n    <a href=\'#private\'>\n      Private <i class=\'count\'>',  user.get('private_characters_count') ,'</i>\n    </a>\n  </li>\n\n  </ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["characters/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (characters) { ; __p.push('\n<ul class="main-content-list">\n  ',  console.log(characters) ,'\n\n');  characters.forEach(function(char) { ; __p.push('\n',  console.log(char.get('attributes')) ,'\n  <li>\n    <header class="item-header group">\n        <ul class="info-vertical">\n          <li>\n            <a href="',  char.get('creator_url') ,'">\n            ',  char.get('creator_username') ,'\n            </a>\n              /\n            <a href="#/characters ',  char.get('id') ,'">\n              ',  char.get('name') ,'\n            </a>\n          </li>\n\n          <li>\n            <small>Last active ', char.get('updated_at') ,' ago\n            </small>\n\n            ');  if (char.get('is_fork_duplicate')) { ; __p.push('\n            <small>Forked from\n\n              <a href=\'',  char.get('original_creator_url') ,'\'>\n              ',  char.get('original_creator_username') ,'\n              </a>\n            </small>\n            ');  } ; __p.push('\n          </li>\n\n          <li>\n            <i>\n              ',  char.get('tagline') ,'\n            </i>\n          </li>\n\n        </ul>\n\n\n        <ul class="social">\n         <li>\n           <a href=\'#{link}\'>\n             Details <i class=\'count\'>',  char.get('details_count') ,'</i>\n           </a>\n         </li>\n\n         <li>\n           <a href=\'#{link}\'>\n             Forks <i class=\'count\'>',  char.get('duplicate_forks_count') ,'</i>\n           </a>\n         </li>\n\n         <li>\n           <a href=\'#{link}\'>\n             Comments <i class=\'count\'>',  char.get('comments_count') ,'</i>\n           </a>\n         </li>\n\n         <li>\n           <a href=\'#{link}\'>\n             Stars <i class=\'count\'>',  char.get('stars_count') ,'</i>\n           </a>\n         </li>\n        </ul>\n\n    </header>\n\n\n    <div class="item-body-text">\n          ',  char.get('details')[1].body.slice(0, 200) ,' ...\n\n    </div>\n\n\n  </li>\n\n\n\n\n\n\n  ');  }) ; __p.push('\n</ul>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>aaaaaaa</p>\n\n<ul>\n',  users.for_each(function(user){ ,'\n\n  <li>\n    <a href="users/', user.get('id'),'">',  user.escape('username')  ,'</a>\n  </li>\n\n\n  ',  });  ,'\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="BLERGH">',  user.username ,'</a>\n');}return __p.join('');};
}).call(this);
...
CharApp.Views.UserShow = Backbone.View.extend({
